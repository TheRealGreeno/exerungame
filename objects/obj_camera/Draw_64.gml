...
// UNUSED	draw_text(60, 40, "HEALTH:" + (global.lifes < 10 ? string(global.lifes) : "10") + (global.lifes > 10 ? ("+" + string(overheal)) : ""));
...
draw_sprite(spr_noiseind, (!obj_exe.gotime && obj_exe.alarm[2] <= 0) ? global.noiselevel : 5, 60, 45);